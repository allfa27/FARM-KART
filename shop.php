...
<section class="products">
     <div class="toy">
            <!-- <video autoplay loop muted plays-inline class="background-video">
               <source src="pexels-júlio-frendes-10744336 (1080p).mp4" type="video/mp4">
            </video> -->
         ...
         <div class="box-container">
          ...
          <form action="" method="post" class="box">
            ...
            <div class="name"><?php echo $fetch_products['type']; ?></div>
            <div class="name"><?php echo $fetch_products['mobile_no']; ?></div>
            <div class="name"><?php echo $fetch_products['description']; ?></div>
            <div class="name"><?php echo $fetch_products['address']; ?></div>

            <input type="hidden" name="product_price" value="<?php echo $fetch_products['price']; ?>">
            
            <input type="hidden" name="product_image" value="<?php echo $fetch_products['image']; ?>">
            <input type="submit" value="add to truck" name="add_to_cart" class="btn">
          </form>
          <?php
               }
            }else{
